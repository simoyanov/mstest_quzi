...
i.close(e,!0)),n.attr("title")&&(n.uniqueId(),i.parents[this.id]={element:this,title:n.attr("title")},n.attr("title",""))}),this._registerCloseHandlers(e,n),this._updateContent(n,e))},_updateContent:function(t,e){var i,n=this.options.content,s=this,o=e?e.type:null;return"string"==typeof n?this._open(e,t,n):(i=n.call(t[0],function(i){s._delay(function(){t.data("ui-tooltip-open")&&(e&&(e.type=o),this._open(e,t,i))})}),void(i&&this._open(e,t,i)))},_open:function(e,i,n){function s(t){h.of=t,a.is(":hidden")||a.position(h)}var o,a,r,l,h=t.extend({},this.options.position);if(n){if(o=this._find(i))return void o.tooltip.find(".ui-tooltip-content").html(n);i.is("[title]")&&(e&&"mouseover"===e.type?i.attr("title",""):i.removeAttr("title")),o=this._tooltip(i),a=o.tooltip,this._addDescribedBy(i,a.attr("id")),a.find(".ui-tooltip-content").html(n),this.liveRegion.children().hide(),n.clone?(l=n.clone(),l.removeAttr("id").find("[id]").removeAttr("id")):l=n,t("<div>").html(l).appendTo(this.liveRegion),this.options.track&&e&&/^mouse/.test(e.type)?(this._on(this.document,{mousemove:s}),s(e)):a.position(t.extend({of:i},this.options.position)),a.hide(),this._show(a,this.options.show),this.options.show&&this.options.show.delay&&(r=this.delayedShow=setInterval(function(){a.is(":visible")&&(s(h.of),clearInterval(r))},t.fx.interval)),this._trigger("open",e,{tooltip:a})}},_registerCloseHandlers:function(e,i){var n={keyup:function(e){if(e.keyCode===t.ui.keyCode.ESCAPE){var n=t.Event(e);n.currentTarget=i[0],this.close(n,!0)}}};i[0]!==this.element[0]&&(n.remove=function(){this._removeTooltip(this._find(i).tooltip)}),e&&"mouseover"!==e.type||(n.mouseleave="close"),e&&"focusin"!==e.type||(n.focusout="close"),this._on(!0,i,n)},close:function(e){var i,n=this,s=t(e?e.currentTarget:this.element),o=this._find(s);return o?(i=o.tooltip,void(o.closing||(clearInterval(this.delayedShow),s.data("ui-tooltip-title")&&!s.attr("title")&&s.attr("title",s.data("ui-tooltip-title")),this._removeDescribedBy(s),o.hiding=!0,i.stop(!0),this._hide(i,this.options.hide,function(){n._removeTooltip(t(this))}),s.removeData("ui-tooltip-open"),this._off(s,"mouseleave focusout keyup"),s[0]!==this.element[0]&&this._off(s,"remove"),this._off(this.document,"mousemove"),e&&"mouseleave"===e.type&&t.each(this.parents,function(e,i){t(i.element).attr("title",i.title),delete n.parents[e]}),o.closing=!0,this._trigger("close",e,{tooltip:i}),o.hiding||(o.closing=!1)))):void s.removeData("ui-tooltip-open")},_tooltip:function(e){var i=t("<div>").attr("role","tooltip").addClass("ui-tooltip ui-widget ui-corner-all ui-widget-content "+(this.options.tooltipClass||"")),n=i.uniqueId().attr("id");return t("<div>").addClass("ui-tooltip-content").appendTo(i),i.appendTo(this.document[0].body),this.tooltips[n]={element:e,tooltip:i}},_find:function(t){var e=t.data("ui-tooltip-id");return e?this.tooltips[e]:null},_removeTooltip:function(t){t.remove(),delete this.tooltips[t.attr("id")]},_destroy:function(){var e=this;t.each(this.tooltips,function(i,n){var s=t.Event("blur"),o=n.element;s.target=s.currentTarget=o[0],e.close(s,!0),t("#"+i).remove(),o.data("ui-tooltip-title")&&(o.attr("title")||o.attr("title",o.data("ui-tooltip-title")),o.removeData("ui-tooltip-title"))}),this.liveRegion.remove()}})}),function(t){"function"==typeof define&&define.amd?define(["jquery"],t):t(jQuery)}(function(t,e){function i(t){var e=window.pageXOffset,i=window.pageYOffset,n=t.clientX,s=t.clientY;return 0===t.pageY&&Math.floor(s)>Math.floor(t.pageY)||0===t.pageX&&Math.floor(n)>Math.floor(t.pageX)?(n-=e,s-=i):(s<t.pageY-i||n<t.pageX-e)&&(n=t.pageX-e,s=t.pageY-i),{clientX:n,clientY:s}}function n(e,n){if(!(!s&&e.originalEvent.touches.length>1||s&&!e.isPrimary)){var o=s?e.originalEvent:e.originalEvent.changedTouches[0],a=document.createEvent("MouseEvents"),r=i(o);t(o.target).is("input")||t(o.target).is("textarea")?e.stopPropagation():e.preventDefault(),a.initMouseEvent(n,!0,!0,window,1,e.screenX||o.screenX,e.screenY||o.screenY,e.clientX||r.clientX,e.clientY||r.clientY,!1,!1,!1,!1,0,null),e.target.dispatchEvent(a)}}var s=window.navigator.pointerEnabled||window.navigator.msPointerEnabled;if(t.support.touch="ontouchend"in document||s,t.support.touch&&t.ui.mouse){var o,a=t.ui.mouse.prototype,r=a._mouseInit,l=a._mouseDestroy;a._touchStart=function(t){o||!s&&!this._mouseCapture(t.originalEvent.changedTouches[0])||(o=!0,this._touchMoved=0,n(t,"mouseover"),n(t,"mousemove"),n(t,"mousedown"))},a._touchMove=function(t){o&&(this._touchMoved+=1,n(t,"mousemove"))},a._touchEnd=function(t){o&&(n(t,"mouseup"),n(t,"mouseout"),this._touchMoved<=5&&n(t,"click"),o=!1)},a._mouseInit=function(){this.element.on({touchstart:t.proxy(this,"_touchStart"),touchmove:t.proxy(this,"_touchMove"),touchend:t.proxy(this,"_touchEnd"),pointerDown:t.proxy(this,"_touchStart"),pointerMove:t.proxy(this,"_touchMove"),pointerUp:t.proxy(this,"_touchEnd"),MSPointerDown:t.proxy(this,"_touchStart"),MSPointerMove:t.proxy(this,"_touchMove"),MSPointerUp:t.proxy(this,"_touchEnd")}),r.call(this)},a._mouseDestroy=function(){this.element.off({touchstart:t.proxy(this,"_touchStart"),touchmove:t.proxy(this,"_touchMove"),touchend:t.proxy(this,"_touchEnd"),pointerDown:t.proxy(this,"_touchStart"),pointerMove:t.proxy(this,"_touchMove"),pointerUp:t.proxy(this,"_touchEnd"),MSPointerDown:t.proxy(this,"_touchStart"),MSPointerMove:t.proxy(this,"_touchMove"),MSPointerUp:t.proxy(this,"_touchEnd")}),l.call(this)}}});var social={init:function(){$(document).on("click",".social-btn",function(t){t.preventDefault();var e=$(this).attr("data-network"),i=$(this).attr("data-purl"),n=$(this).attr("data-title"),s=$(this).attr("data-img"),o=$(this).attr("data-text");social.share(e,i,n,s,o)}),redirect&&window.setTimeout(function(){window.location="/"+redirect},2e3)},popup:function(t){window.open(t,"","toolbar=0,status=0,width=626,height=436")},share:function(t,e,i,n,s){"vk"==t&&(url="http://vkontakte.ru/share.php?",url+="url="+encodeURIComponent(e),url+="&title="+encodeURIComponent(i),url+="&description="+encodeURIComponent(s),url+="&image="+encodeURIComponent(n),url+="&noparse=true",social.popup(url)),"facebook"==t&&(url="http://www.facebook.com/sharer.php?s=100",url+="&p[title]="+encodeURIComponent(i),url+="&p[summary]="+encodeURIComponent(s),url+="&p[url]="+encodeURIComponent(e),url+="&p[images][0]="+encodeURIComponent(n),social.popup(url)),"twitter"==t&&(url="http://twitter.com/share?",url+="text="+encodeURIComponent(i),url+="&url="+encodeURIComponent(e),url+="&counturl="+encodeURIComponent(e),Share.popup(url),social.popup(url)),"ok"==t&&(url="http://www.odnoklassniki.ru/dk?st.cmd=addShare&st.s=1",url+="&st.comments="+encodeURIComponent(s),url+="&st._surl="+encodeURIComponent(e),social.popup(url)),"mailru"==t&&(url="http://connect.mail.ru/share?",url+="url="+encodeURIComponent(e),url+="&title="+encodeURIComponent(i),url+="&description="+encodeURIComponent(s),url+="&imageurl="+encodeURIComponent(n),social.popup(url))}},MOUSE_DOWN="click",main_frame=$("#main_frame"),body_size=$("body"),centrer_frame=$("#center_frame"),time=500,ratio=.562,frame_w,frame_h,frame_d,centrer_frame_w,centrer_frame_h,centrer_frame_t,centrer_frame_l,$load_frame=$("#load_frame"),transitions_av=!0,mobile_scale=1,min_window_h=650,overlayMenu=$("#overlay-menu"),slider=$("#slides"),navbar=$(".navbar-custom"),modules=$(".module-hero, .module, .module-small"),windowWidth=Math.max($(window).width(),window.innerWidth),navbatTrans,mobileTest,animate_el=!0,visual={init:function(){visual.navbarCheck(navbar),visual.navbarAnimation(navbar),visual.moduleInit(),visual.scaleContent(),visual.animateElements(),document.ontouchmove=function(t){},Modernizr.csstransitions&&Modernizr.cssanimations||(transitions_av=!1,$.fn.transition=$.fn.animate,$.fn.transitionStop=$.fn.stop),(mobile||tablet)&&(MOUSE_DOWN="touchstart"),mobile?body_size.addClass("mobile"):body_size.addClass("no-mobile"),$(document).on(MOUSE_DOWN,".section-scroll",function(t){t.preventDefault();var e=$(this);$("html, body").stop().animate({scrollTop:$(e.attr("href")).offset().top},1e3)}),$(document).on(MOUSE_DOWN,"#toggle-menu",function(t){t.preventDefault(),visual.showMenu(),$("body").addClass("aux-navigation-active")}),$(document).on(MOUSE_DOWN,"#overlay-menu-hide",function(t){t.preventDefault(),visual.hideMenu(),$("body").removeClass("aux-navigation-active")}),$(window).keydown(function(t){overlayMenu.hasClass("active")&&27===t.which&&hideMenu()})},scrolling:function(){visual.navbarAnimation(navbar)},resize:function(){visual.moduleResize(),visual.scaleContent()},showMenu:function(){navbar.transition({opacity:0,top:-80},{duration:150,easing:"easeInOutQuart"}),overlayMenu.addClass("active")},hideMenu:function(){navbar.transition({opacity:1,top:0},{duration:150,easing:"easeInOutQuart"}),overlayMenu.removeClass("active")},moduleInit:function(){modules.each(function(){$(this).attr("data-background")&&$(this).css("background-image","url("+$(this).attr("data-background")+")"),$(this).hasClass("module-hero")&&($(window).height()>min_window_h?$(this).height(.4*$(window).height()):$(this).height(.4*min_window_h)),$(this).hasClass("module-full-height")&&($(window).height()>min_window_h?$(this).height($(window).height(min_window_h-120)):$(this).height(min_window_h-120)),mobile===!0?$(this).hasClass(".module-parallax")&&$(this).css({"background-attachment":"scroll"}):$(this).hasClass(".module-parallax")&&$(this).css({"background-attachment":"fixed"})}),$(window).height()>min_window_h?$(".block-h-hero").height($(window).height()):$(".block-h-hero").height(min_window_h)},initHome:function(){$(".module-achievement__test-image").each(function(){var t=$(this).width();$(this).find("img").next().width(.7*t)})},moduleResize:function(){modules.each(function(){$(this).hasClass("module-hero")&&($(window).height()>min_window_h?$(this).height(.4*$(window).height()):$(this).height(.4*min_window_h)),$(this).hasClass("module-full-height")&&($(window).height()>min_window_h?$(this).height($(window).height()-120):$(this).height(min_window_h-120))}),$(window).height()>min_window_h?$(".block-h-hero").height($(window).height()):$(".block-h-hero").height(min_window_h)},navbarAnimation:function(t){var e=$(window).scrollTop();t.length>0&&navbatTrans!==!1&&(e>=5?t.removeClass("navbar-transparent"):t.addClass("navbar-transparent"))},navbarCheck:function(){navbatTrans=navbar.length>0&&navbar.hasClass("navbar-transparent")?!0:!1},preloader:function(){redirect||($(".loader").fadeOut(),$(".page-loader").delay(350).fadeOut("slow"))},scale_show:function(t,e,i){t.css({opacity:0,scale:.8}).delay(e).transition({opacity:1,scale:1},i)},scale_hide:function(t,e,i){t.delay(e).transition({opacity:0,scale:.8},i)},element_check_size:function(t){t.css({width:centrer_frame_w,height:centrer_frame_h,top:centrer_frame_t,left:centrer_frame_l})},scaleContent:function(){frame_w=body_size.width(),frame_h=body_size.height(),frame_d=frame_h/frame_w,frame_d>ratio?(centrer_frame_w=frame_h/ratio,centrer_frame_h=frame_h,centrer_frame_t=0,centrer_frame_l=.5*(frame_w-centrer_frame_w)):(centrer_frame_w=frame_w,centrer_frame_h=frame_w*ratio,centrer_frame_t=.5*(frame_h-centrer_frame_h),centrer_frame_l=0),visual.element_check_size(centrer_frame)},animate:function(t,e){animate_el?($(t).addClass(e),animate_el=!1):($(t).removeClass(e),animate_el=!0)},animateElements:function(){setInterval(function(){visual.animate(".card--news","animated tada")},2e3)}},count_card=0,json_achievement=[],raiting={init:function(){mobile?raiting.mobileRatingAction():raiting.nomobileRatingAction(),$(document).on(MOUSE_DOWN,"#send_result_raiting",function(t){t.preventDefault(),$(this).hasClass("disabled")||raiting.sendResult()}),$(document).on(MOUSE_DOWN,"#send-result-mobile",function(t){t.preventDefault(),raiting.sendResult()}),$(document).on(MOUSE_DOWN,"#popup-mobile-hide",function(t){t.preventDefault(),$(".popup-mobile-action").removeClass("active")}),$(".preaction-loader").removeClass("hidden"),$(document).on(MOUSE_DOWN,"#preaction-hide",function(t){t.preventDefault(),$(".preaction-loader").addClass("hidden")})},sendResult:function(){var t=$("#achievements-form").serializeArray(),e="/iwanttovote";$.ajax({url:e,type:"POST",data:t,dataType:"json",beforeSend:function(){},complete:function(){},success:function(t){t.success?(yaCounter31626893.reachGoal(action_cl_rbtn_ya),window.location.replace(t.redirect)):$.each(t.error,function(t,e){})},error:function(t,e,i){}})},mobileRatingAction:function(){$(document).on(MOUSE_DOWN,".chose-achievement-mobile",function(){console.log($(this).data("item"));var t=$(this).data("item");5>count_card&&($("#"+t).addClass("item-select"),$(this).addClass("hidden").next().removeClass("hidden"),count_card++,raiting.actionForMobile())}),$(document).on(MOUSE_DOWN,".chose-achievement-mobile-disable",function(){console.log($(this).data("item"));var t=$(this).data("item");$("#"+t).removeClass("item-select"),$(this).addClass("hidden").prev().removeClass("hidden"),count_card--})},nomobileRatingAction:function(){$("#achievements-gallery").owlCarousel({touchDrag:!1,dragBeforeAnimFinish:!1,mouseDrag:!1,itemsDesktop:[1199,5],itemsDesktopSmall:[980,5],itemsTablet:[768,4],itemsTabletSmall:!1,itemsMobile:!1,pagination:!1,afterMove:raiting.scrollGallery,afterUpdate:raiting.resize}),$(document).on(MOUSE_DOWN,"#larrow",function(t){t.preventDefault(),$("#achievements-gallery").trigger("owl.prev"),raiting.scrollGallery}),$(document).on(MOUSE_DOWN,"#rarrow",function(t){t.preventDefault(),$("#achievements-gallery").trigger("owl.next"),raiting.scrollGallery}),raiting.resize(),$(".owl-item").draggable({revert:!0,helper:raiting.helper,appendTo:"body",start:raiting.startDrag}),$(".achievement-item").droppable({accept:".owl-item",hoverClass:"hovered",drop:raiting.handleCardDrop}),$(document).on(MOUSE_DOWN,".gallery_item-action",function(t){$("#send_result_raiting").addClass("disabled"),t.preventDefault();var e=$(this).parents(".achievement-item");e.droppable("enable"),console.log($(this).parents(".gallery_item-block").attr("id"));var i="#main_"+$(this).parents(".gallery_item-block").attr("id");$(i).parents(".owl-item").draggable("enable"),$(this).parents(".gallery_item-block").remove(),count_card--})},actionForMobile:function(){5==count_card&&($(".item-select").each(function(t){item={},item.achievement_id=$(this).find(".gallery_item-block").data("achievement"),item.raiting_id=$(this).find(".gallery_item-block").data("position"),json_achievement.push(item)}),$(".popup-mobile-action").addClass("active"))},actionForNoMobile:function(){5==count_card?(json_achievement=[],$(".achievement").each(function(t){item={},item.achievement_id=$(this).find(".gallery_item-block").data("achievement"),item.raiting_id=$(this).find(".gallery_item-block").data("position"),json_achievement.push(item)}),$("#send_result_raiting").removeClass("disabled")):$("#send_result_raiting").addClass("disabled")},initAction:function(){mobile?raiting.actionForMobile():raiting.actionForNoMobile()},handleCardDrop:function(t,e){count_card++,e.draggable.draggable("disable"),$(this).droppable("disable");var i=$(e.draggable).attr("id"),n=$(e.draggable).find(".gallery_item-block").clone();n.data("id_number",i),$(this).append(n),n.position({of:$(this),my:"left top",at:"left top"}),e.draggable.draggable("option","revert",!1),raiting.initAction()},scrollGallery:function(){var t=$("#achievements-gallery").data("owlCarousel");console.log(t),t.currentItem===t.maximumItem?($("#larrow").removeClass("hidden"),$("#rarrow").addClass("hidden")):0===t.currentItem?($("#rarrow").removeClass("hidden"),$("#larrow").addClass("hidden")):($("#rarrow").removeClass("hidden"),$("#larrow").removeClass("hidden"))},startDrag:function(t,e){$(e.helper).addClass("ui-draggable-helper")},helper:function(){var t=$(this).clone();return t},resize:function(){if($(".achievements-bg").length>0&&!mobile){var t=$(".achievements-bg").width(),e=t/5;$(".achievement").css({width:e});var i=$(".gallery_item-heading").find("p").map(function(){return $(this).height()}).get(),n=Math.max.apply(null,i);$(".gallery_item-heading").css({height:n+30})}if($(".achievements-gallery").length>0&&!mobile){var i=$(".gallery_item-heading").find("p").map(function(){return $(this).height()}).get(),n=Math.max.apply(null,i);$(".gallery_item-heading").css({height:n+30}),_heightGalleryItem=$(".owl-item").height(),_widthGalleryItem=$(".owl-item").width(),$(".left-arrow").css({width:_widthGalleryItem/2,height:_heightGalleryItem}),$(".right-arrow").css({width:_widthGalleryItem/2,height:_heightGalleryItem})}if($(".achievements").length>0&&!mobile){var t=$(".achievements").width(),e=t/5,s=$(".achievements-gallery_item").height();$(".achievement").css({width:e,height:s})}if($(".my-achievements").length>0&&!mobile){var t=$(".my-achievements").width(),e=t/5;$(".achievement").css({width:e});var i=$(".gallery_item-heading").find("p").map(function(){return $(this).height()}).get(),n=Math.max.apply(null,i);$(".gallery_item-heading").css({height:n+30})}}},count_step=0,count_item=0,current_correct_item=0,current_no_correct_item=0,current_other_item=0,current_correct_item=0,quiz_active=!0,send_data=[],_data=[],step={init:function(){step.initStep(),step.initBtnStep()},initStep:function(){"medium"==type&&$(".preaction-loader-test").removeClass("hidden"),count_step=$(document).find(".wizard").find(".pagination").find("li").length,$("#all_question").html(count_step),step.wizard(1)},initBtnStep:function(){$(".answer-btn").on(MOUSE_DOWN,function(t){t.preventDefault();var e=$(this).data("step"),i=$(this).data("voice");$(this).data("achievement"),$(this).data("answer");$("#pstep_"+e).attr("class","").removeClass("active").addClass(i),$("#step_"+e).find(".avatar").attr("class","").addClass("avatar").addClass(i),quiz_active&&($("#poll-form").empty(),$("#poll-form").append('<input type="hidden" name="quiz_id" value="'+q+'">'),current_correct_item=0,current_no_correct_item=0,current_other_item=0,count_item=0,$(document).find(".pagination").find("li").each(function(t){$(this).hasClass("correct")&&(count_item+=1,current_correct_item+=1,$("#poll-form").append('<input type="hidden" name="answer['+$(this).data("achievement")+']" value="1">')),$(this).hasClass("no-correct")&&(count_item+=1,current_no_correct_item+=1,$("#poll-form").append('<input type="hidden" name="answer['+$(this).data("achievement")+']" value="0">')),$(this).hasClass("other")&&(count_item+=1,current_other_item+=1,$("#poll-form").append('<input type="hidden" name="answer['+$(this).data("achievement")+']" value="2">'))}),$("#current_count").html(current_correct_item+" "+step.decOfNum(current_correct_item,["чиновник","чиновника","чиновников"])),step.showNextStep(e))}),$("#send_result_quiz_medium").on(MOUSE_DOWN,function(t){t.preventDefault(),$(this).hasClass("disabled")||(quiz_active=!1,step.sendResult())}),$("#mobile_send_result_quiz_medium").on(MOUSE_DOWN,function(t){t.preventDefault(),$(this).hasClass("disabled")||(quiz_active=!1,step.sendResult())}),$(".pagination-default").find("a").on(MOUSE_DOWN,function(t){t.preventDefault()}),$(".pagination-action").find("a").on(MOUSE_DOWN,function(t){t.preventDefault();var e=$(this).data("step");step.wizard(e)}),$(document).on(MOUSE_DOWN,"#preaction-hide-loader-test",function(t){t.preventDefault(),$(".preaction-loader-test").addClass("hidden")}),$(document).on(MOUSE_DOWN,"#next-step",function(t){t.preventDefault();var e=$(".pagination").find(".active").find("a").data("step"),i=e+1;e==count_step&&(i=1),step.wizard(i)}),$(document).on(MOUSE_DOWN,"#prev-step",function(t){t.preventDefault();var e=$(".pagination").find(".active").find("a").data("step"),i=e-1;1==e&&(i=count_step),step.wizard(i)})},showNextStep:function(t){"simple"==type?t+1>count_step?(quiz_active=!1,step.endWizard()):step.wizard(t+1):"medium"==type&&(console.log("count_step           ->>>"+count_step),count_item==count_step&&(current_correct_item<=count_correct&&current_correct_item>0||current_no_correct_item==count_step&&0==current_correct_item||current_other_item==count_step&&0==current_correct_item||current_correct_item==count_step?($("#send_result_quiz_medium").removeClass("disabled"),mobile&&$("#mobile_send_result_quiz_medium").removeClass("disabled")):($("#send_result_quiz_medium").addClass("disabled"),mobile&&$("#mobile_send_result_quiz_medium").addClass("disabled"))),t==count_step?step.wizard(1):step.wizard(t+1))},endWizard:function(){step.sendResult()},wizard:function(t){$(document).find(".step_view").removeClass("current-step"),$("#step_"+t).addClass("current-step"),$(document).find(".pagination li").removeClass("active"),$("#pstep_"+t).removeClass("disabled").addClass("active"),$(".mobile-pagination").find(".active").html(t)},resize:function(){},decOfNum:function(t,e){return cases=[2,0,1,1,1,2],e[t%100>4&&20>t%100?2:cases[5>t%10?t%10:5]]},sendResult:function(){var t=$("#poll-form").serializeArray();yaCounter31626893.reachGoal(rbtn_share);var e="/send_result_quiz";$.ajax({url:e,type:"POST",data:t,dataType:"json",beforeSend:function(){},complete:function(){},success:function(t){t.success?window.location.replace(t.redirect):$.each(t.error,function(t,e){})},error:function(t,e,i){}})}},fighter_1=0,fighter_2=0,battle={init:function(){battle.initBattle(),battle.initBtnBattle()},initBattle:function(){$(".battle").find(".animate-element").each(function(t){visual.scale_show($(this),time+300*t,350)}),$(".hat_1").css({display:"none"}).transition({x:"-200px"}),$(".hat_2").css({display:"none"}).transition({x:"200px"}),ion.sound({sounds:[{name:"start",loop:!0,volume:.5},{name:"fight",volume:.5},{name:"battle",loop:!0,volume:.2},{name:"fighter_1_1",volume:.5},{name:"fighter_1_2",volume:.5},{name:"fighter_1_3",volume:.5},{name:"fighter_1_4",volume:.5},{name:"fighter_1_5",volume:.5},{name:"fighter_2_1",volume:.5},{name:"fighter_2_2",volume:.5},{name:"fighter_2_3",volume:.5},{name:"fighter_2_4",volume:.5},{name:"fighter_2_5",volume:.5},{name:"hover",volume:.5},{name:"mk_1",volume:.5},{name:"mk_2",volume:.5},{name:"mk_3",volume:.5},{name:"mk_4",volume:.5},{name:"mk_5",volume:.5}],path:"sounds/",preload:!0,volume:1}),mobile||($("#fighter_1").on("mouseenter",function(){$(".hat_1").css({display:"block"}).transition({x:"0px"},250)}).on("mouseleave",function(){$(".hat_1").transition({x:"-200px"},250)}),$("#fighter_2").on("mouseenter",function(){$(".hat_2").css({display:"block"}).transition({x:"0px"},250)}).on("mouseleave",function(){$(".hat_2").transition({x:"200px"},250)}))},initBtnBattle:function(){$("#start_game").on(MOUSE_DOWN,function(t){t.preventDefault(),battle.launchStartScreen(),$(".preaction-battle").remove()}),$(".battle-strike").on(MOUSE_DOWN,function(t){t.preventDefault();var e=$(this).data("step"),i=$(this).data("voice"),n=($(this).data("achievement"),$(this).data("answer"));battle.strike(n),$("#pstep_"+e).attr("class","").removeClass("active").addClass(i),$("#step_"+e).addClass("hidden").find(".avatar").attr("class","").addClass("avatar").addClass(i),quiz_active&&($("#poll-form").empty(),$("#poll-form").append('<input type="hidden" name="quiz_id" value="'+q+'">'),current_correct_item=0,count_item=0,$(document).find(".pagination").find("li").each(function(t){$(this).hasClass("correct")&&(count_item+=1,$("#poll-form").append('<input type="hidden" name="answer['+$(this).data("achievement")+']" value="0">')),$(this).hasClass("no-correct")&&(count_item+=1,$("#poll-form").append('<input type="hidden" name="answer['+$(this).data("achievement")+']" value="1">'))}),battle.showNextStep(e))})},strike:function(t){var e=$(".count-time").width(),i=$(".module__fighter__image").width(),n=i+e;mobile&&(n=150);var s="fighter_"+t+"_"+(Math.floor(5*Math.random())+1);ion.sound.play(s),"1"==t&&(fighter_2+=1,$("#fighter_2").css({"z-index":10}),$("#fighter_1").css({"z-index":20}).next().css({opacity:0}).delay(100).transition({opacity:1,x:n+"px"},250,function(){$("#fighter_2").css({x:50}).transition({x:0},350,"easeInOutQuint",function(){$("#fighter_1").next().css({opacity:0}).transition({x:"0px"}),1&fighter_2||($(this).find("img").removeClass("current"),$(this).find("img").each(function(){$(this).attr("data-strike")==fighter_2&&$(this).addClass("current")}))})})),"2"==t&&(fighter_1+=1,$("#fighter_1").css({"z-index":10}),$("#fighter_2").css({"z-index":20}).next().css({opacity:0}).delay(100).transition({opacity:1,x:"-"+n+"px"},250,function(){$("#fighter_1").css({x:-50}).transition({x:0},350,"easeInOutQuint",function(){$("#fighter_2").next().css({opacity:0}).transition({x:"0px"}),1&fighter_1||($(this).find("img").removeClass("current"),$(this).find("img").each(function(){$(this).attr("data-strike")==fighter_1&&$(this).addClass("current")}))})}))},wizard:function(t){$(document).find(".round_view").removeClass("current-step"),$("#step_"+t).addClass("current-step"),$(document).find(".pagination li").removeClass("active"),$("#pstep_"+t).removeClass("disabled").addClass("active"),$(document).find(".count_round").html(t),$(".mobile-pagination").find(".active").html(t),battle.resize()},launchStartScreen:function(){count_step=$(document).find(".battle").find(".pagination").find("li").length,$(".count-time").find("img").delay(250).css({display:"none"}),$(".time-round").css({opacity:0,scale:.5,display:"block"}).delay(250).transition({scale:1,opacity:1},250),$(".module-subtitle").css({opacity:0,scale:.5,display:"block"}).delay(250).transition({scale:1,opacity:1},250),battle.wizard(1)},showNextStep:function(t){t+1>count_step?(quiz_active=!1,setTimeout(function(){battle.endWizard()},500)):setTimeout(function(){battle.wizard(t+1)},500)},endWizard:function(){battle.sendResult()},resize:function(){var t=$(".current-step").find(".col-xs-6").width(),e=$(".current-step").find(".pic-strike").width(),i=t-e,n=$(".current-step").find(".pic-strike").height();mobile&&(i="100%",n="auto"),$(".current-step").find(".name-strike").css({height:n}),$(".current-step").find(".name-strike").css({width:i})},sendResult:function(){var t=$("#poll-form").serializeArray();yaCounter31626893.reachGoal("rbtn_quiz_battle_mer");var e="/send_result_quiz";$.ajax({url:e,type:"POST",data:t,dataType:"json",beforeSend:function(){},complete:function(){},success:function(t){t.success?window.location.replace(t.redirect):$.each(t.error,function(t,e){})},error:function(t,e,i){}})}},action={init:function(){$(".upload_achiev").length>0&&$(".navbar-right").addClass("hidden"),$(document).on(MOUSE_DOWN,"#send_result_question",function(t){t.preventDefault(),action.sendAddQuestion(),yaCounter31626893.reachGoal("add_the_object")})},sendAddQuestion:function(){var t=$("#add-form").serializeArray(),e="/upload_achiviement";$.ajax({url:e,type:"POST",data:t,dataType:"json",beforeSend:function(){},complete:function(){},success:function(t){$("#add-form").find(".form-group").removeClass("has-error").find(".help-block").empty(),t.success?($(".ajax-hidden").addClass("hidden"),$(".ajax-response").removeClass("hidden")):$.each(t.error,function(e,i){t.error[e]&&($("#add-form").find("#input-"+e).parents(".form-group").addClass("has-error"),$("#add-form").find("#input-"+e).next().html(i))})},error:function(t,e,i){}})}};$(document).ready(function(){visual.init(),action.init(),$(".achievements").length>0&&raiting.init(),($(".achievements").length>0||$(".my-achievements").length>0||$(".achievements-bg").length>0)&&(setTimeout(function(){raiting.resize()},500),setTimeout(function(){raiting.resize()},1500),setTimeout(function(){raiting.resize()},2500)),$(".wizard").length>0&&step.init(),$(".battle").length>0&&battle.init(),$(".wizard").length>0&&step.init(),$(".module-achievement__test-image").length>0&&visual.initHome(),social.init()}),$(window).on("resize",function(){visual.resize(),($(".achievements").length>0||$(".my-achievements").length>0||$(".achievements-bg").length>0)&&raiting.resize(),$(".wizard").length>0&&step.resize(),$(".battle").length>0&&battle.resize(),$(".module-achievement__test-image").length>0&&visual.initHome()}),$(window).on("load",function(){visual.preloader()}),$(window).on("scroll",function(){visual.scrolling()});