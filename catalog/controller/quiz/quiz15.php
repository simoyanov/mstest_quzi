...
<?php
class ControllerQuizQuiz15 extends Controller {
  //тест сравнение
  public function index() {
    ...
    $this->document->addScript('catalog/assets/js/sravnenie_moscow.v.1.1.js');
   ...
   if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/quiz/quiz15.tpl')) {
      return $this->load->view($this->config->get('config_template') . '/template/quiz/quiz15.tpl', $data);
    } else {
      return $this->load->view('default/template/quiz/quiz15.tpl', $data);
    }
  }
  ...
  public function result(){
    ...
    // vk - vkontakte
    $data['social'] = 'false';
    $template_name = 'quiz15_result.tpl';
