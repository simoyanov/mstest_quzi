...
<?php
class ControllerQuizQuiz18 extends Controller {
  //тест сравнение
  public function index() {
    ...
    $this->document->addScript('catalog/view/module_script/znatok_duma.0.1.0.js');
   ...
   if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/quiz/quiz18.tpl')) {
      return $this->load->view($this->config->get('config_template') . '/template/quiz/quiz18.tpl', $data);
    } else {
      return $this->load->view('default/template/quiz/quiz18.tpl', $data);
    }
  }
  ...
  public function result(){
    ...
    // vk - vkontakte
    $data['social'] = 'false';
    $template_name = 'quiz18_result.tpl';
