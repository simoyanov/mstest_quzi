...
<?php
class ControllerQuizQuiz17 extends Controller {
  //тест сравнение
  public function index() {
    ...
    $this->document->addScript('catalog/assets/js/lib/TweenMax.min.js');
    $this->document->addScript('catalog/assets/js/lib/jquery.gsap.min.js');
    $this->document->addScript('catalog/assets/js/battle_city.v.1.0.js');
   ...
   if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/quiz/quiz17.tpl')) {
      return $this->load->view($this->config->get('config_template') . '/template/quiz/quiz17.tpl', $data);
    } else {
      return $this->load->view('default/template/quiz/quiz17.tpl', $data);
    }
  }
  ...
  public function result(){
    ...
    // vk - vkontakte
    $data['social'] = 'false';
    $template_name = 'quiz17_result.tpl';
