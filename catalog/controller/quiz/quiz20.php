...
<?php
class ControllerQuizQuiz20 extends Controller {
  //тест сравнение
  public function index() {
    ...
    // $this->document->addStyle('catalog/view/theme/duma/assets/css/duma.css');
    // $this->document->addScript('catalog/view/theme/duma/assets/js/duma.js');
    $this->document->addScript('catalog/view/module_script/oceni_result.js');
    $this->document->addScript('catalog/view/module_script/jquery-ui.min.js');
   ...
   if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/quiz/quiz20.tpl')) {
      return $this->load->view($this->config->get('config_template') . '/template/quiz/quiz20.tpl', $data);
    } else {
      return $this->load->view('duma/template/quiz/quiz20.tpl', $data);
    }
  }
  ...
  public function result(){
    ...
    // vk - vkontakte
    $data['social'] = 'false';
    $template_name = 'quiz20_result.tpl';
    ...
    $image->save(DIR_SHARE . $new_image);

    $data['share_image'] = 'share/' . $new_image;
...
*/
    ...
    if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/quiz/'.$template_name)) {
      ...
      return $this->load->view('duma/template/quiz/'.$template_name, $data);
    }
  }
}
