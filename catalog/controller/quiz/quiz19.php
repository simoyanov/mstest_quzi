...
<?php
class ControllerQuizQuiz19 extends Controller {
  //тест сравнение
  public function index() {
    ...
    $this->document->addScript('catalog/view/module_script/kreslo_deputata.1.1.js');
   ...
   if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/quiz/quiz19.tpl')) {
      return $this->load->view($this->config->get('config_template') . '/template/quiz/quiz19.tpl', $data);
    } else {
      return $this->load->view('duma/template/quiz/quiz19.tpl', $data);
    }
  }
  ...
  public function result(){
    ...
    // vk - vkontakte
    $data['social'] = 'false';
    $template_name = 'quiz19_result.tpl';
