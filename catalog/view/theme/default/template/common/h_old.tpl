...
<script src="catalog/assets/javascript/vote_moscow.js" type="text/javascript"></script>
  <!-- Javascript files -->
  ...
  <?php } ?>
  <!-- Template core CSS -->
  <link href="catalog/assets/css/vote_moscow.css" rel="stylesheet">
  ...
  <div id="overlay-menu" class="overlay-menu">
    ...
    <div class="overlay-menu-inner">
      <nav class="overlay-menu-nav">
        <ul id="nav">
          <li><a href="/turnir_otkrutie" title="Турнир">Турнир "ОТКРЫТИЕ"</a></li>
