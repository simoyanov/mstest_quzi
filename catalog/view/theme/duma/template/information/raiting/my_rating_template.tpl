  ...
  <div class="container">
      <div class="row module-heading">
        <div class="col-sm-12 ">
          ...
          <h2 class="module__heading__subtitle  text-center font-alt m-b-10 m-t-0"><?php echo $sub_heading_title;?></h2>
        </div>
      </div>
      <div class="row">
        <!-- CONTENT -->
        ...
        <div class="<?php echo $class; ?> text-center row my-raiting">
          ...
          <div class="col-sm-12 col-md-2 text-right">
            <ul class="social-icons m-t-0">
              <li><span class="vk-icon social-btn" onclick="yaCounter31626893.reachGoal('rating_vk_sharing'); return true;" data-network="vk" data-purl="<?php echo $share_url_vk;?>" data-title='<?php echo $share_title; ?>' data-img="<?php echo $share_img;?>" data-text="<?php echo $share_text; ?>"></span></li>
              <li><span class="facebook-icon social-btn" onclick="yaCounter31626893.reachGoal('rating_fb_sharing'); return true;" data-network="facebook" data-purl="<?php echo $share_url_fb;?>" data-title='<?php echo $share_title; ?>' data-img="<?php echo $share_img;?>" data-text="<?php echo $share_text; ?>"></span></li>
              <li><span class="ok-icon social-btn" onclick="yaCounter31626893.reachGoal('rating_ok_sharing'); return true;" data-network="ok" data-purl="<?php echo $share_url_ok;?>" data-title='<?php echo $share_title; ?>' data-img="<?php echo $share_img;?>" data-text="<?php echo $share_text; ?>"></span></li>
            </ul>
          </div>
