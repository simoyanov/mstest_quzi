    ...
    <div class="row">
      <div class="col-xs-12 col-sm-12  col-md-12  col-lg-12 module module__border module__border--white module__border--min">
        ...
        <div class="hover_scr_on_mob hidden" id="help_scr">
                        <p class="hover_scr_on_mob__text open-sans-lite">Нажмите на законопроект и выбери характеристику
                    ...
                    <div class="hover_scr_on_mob-left " id="part_scr">
                        ...
                        <div class="hover_scr_on_mob-left__partia open-sans-exbolt" id="btn_well">
                            ПРОШЛО МИМО МЕНЯ 
                        </div>
                        <div class="hover_scr_on_mob-left__partia open-sans-exbolt" id="btn_bad">
                            ЧТО ЭТО ЗА БРЕД?
                        </div>
