<?php echo $header; ?>
<section class="module first-block">
  <div class="container">
    <div class="row">
    ...
    <div class="row">
        <div class="center-block text-center col-xs-12">
            ...
            <span class="module__subtitle open-sans-lite">скоро начнутся голодные игры в думу 2016</span><br>
            <span class="module__subtitle open-sans-lite">эти 27 человек сейчас у власти. <br>
посмотри на них и выбери лучших!</span>
<!--            <span class="module__subtitle-subtext open-sans-lite">Оцени самоотдачу и эффективность партий. <br> Что было сделано для народа, а что предстоит изменить?</span>-->
        ...
        <div class="row heroes-gif-cont">
               ...
               <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                   <div class="heroes-gif"><img class="boom" src="image/catalog/home/exp_7.gif" width="157"><img class="hero-img" src="image/catalog/gif/havanskaya.gif" width="157" alt=""><div class='border-img'></div><img src="image/catalog/home/plate_sr.png" alt="" class="hero_party_plate"><div class="mark_pos"></div> <div class="mark_neg"></div><div class="heroes-plate heroes-yellow"><span>«Для меня СПС-овцы были слишком крутые. Я Чубайса как организатора очень уважаю, но это человек, который по трупам к светлому будущему — к рынку. Пусть там все вымрут, но мы своего добьемся. Я считаю, что игнорировать социальную составляющую — это рубить сук, на котором сидишь..»</span><span class="heroes-gif-name">Хованская Галина Петровна</span></div></div>
               </div>
               <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
               ...
               <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                   <div class="heroes-gif"><img class="boom" src="image/catalog/home/exp_6.gif" width="157"><img class="hero-img" src="image/catalog/gif/rashkin.gif" width="157" alt=""><div class='border-img'></div><img src="image/catalog/home/plate_kprf.png" alt="" class="hero_party_plate"><div class="mark_pos"></div> <div class="mark_neg"></div><div class="heroes-plate heroes-red"><span>"Пригласили на турнир по пулевой и стендовой стрельбе среди депутатов Думы. Согласился, в качестве мишени хочу Путина".</span><span class="heroes-gif-name">Рашкин Валерий Федорович</span></div></div>
               </div>
               <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
...
<section class="module second-block" data-background="image/catalog/home/bg2.jpg">
