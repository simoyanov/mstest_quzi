                          ...
                          <div class="card-body card-padding">
                            ...
                            <div class="form-group required <?php if (isset($error_title[$language['language_id']])) { ?> has-error <?php } ?>">
                              <div class="fg-line">
                                  ...
                                  <input type="text" name="occasion_group_description[<?php echo $language['language_id']; ?>][title]" value="<?php echo isset($occasion_group_description[$language['language_id']]) ? $occasion_group_description[$language['language_id']]['title'] : ''; ?>"  id="input-title<?php echo $language['language_id']; ?>" class="form-control" />
                              </div>
