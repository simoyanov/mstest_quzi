        ...
        <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form-information">
          <table class="table">
              ...
              <tbody>
                  ...
                  <tr>
                    <td class="text-center"><?php if (in_array($raiting['raiting_id'], $selected)) { ?>
                      <input type="checkbox" name="selected[]" value="<?php echo $raiting['raiting_id']; ?>" checked="checked" />
                      <?php } else { ?>
                      <input type="checkbox" name="selected[]" value="<?php echo $raiting['raiting_id']; ?>" />
                      <?php } ?></td>
                    <td class="text-left"><?php echo $raiting['title']; ?></td>
                    <td class="text-right"><a href="<?php echo $raiting['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                  </tr>
                  <?php } ?>
                  <?php } else { ?>
                  <tr>
