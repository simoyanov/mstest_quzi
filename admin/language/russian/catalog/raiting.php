...
$_['column_raiting_date_begin'] 	= 'Дата начала сезона';
$_['column_raiting_date_end'] 	= 'Дата окончания сезона';
...
// Entry
$_['entry_title']       		= 'Название ретинга';
$_['entry_raiting_date_begin'] 	= 'Дата начала сезона';
$_['entry_raiting_date_end'] 	= 'Дата окончания сезона';
$_['entry_status']     			= 'Статус';
$_['entry_visibility']     		= 'Видимость';
$_['entry_image']        = 'Изображение';
$_['entry_sort_order']       = 'Порядок сортировки';
$_['entry_season']       = 'Сезон';
