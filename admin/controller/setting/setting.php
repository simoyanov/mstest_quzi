...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$data['order_statuses'] = array();//$this->model_localisation_order_status->getOrderStatuses();
		...
		$data['return_statuses'] = array();//$this->model_localisation_return_status->getReturnStatuses();
