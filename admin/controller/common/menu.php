...
class ControllerCommonMenu extends Controller {
	public function index() {
		...
		$data['achievement'] = $this->url->link('catalog/achievement', 'token=' . $this->session->data['token'], 'SSL');
		$data['raiting'] = $this->url->link('catalog/raiting', 'token=' . $this->session->data['token'], 'SSL');
